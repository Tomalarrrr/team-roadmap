      ...
      <div className={styles.gameArea}>
        <div className={styles.playingLayout}>
          <div className={styles.boardWrapper}>
              ...
              return (
                ...
                >
                  <div className={styles.seatLine}>
                    ...
                    <span className={styles.seatScore}>{SCORE[color]}</span>
                  </div>
            ...
            <svg className={styles.timerRing} viewBox="0 0 100 100" aria-hidden="true">
            ...
            <div className={styles.centreStatus} title={`${timeLeft}s left on this turn`}>
              ...
              {timeLeft <= 10 && <span className={styles.turnCount}>{timeLeft}</span>}
            </div>

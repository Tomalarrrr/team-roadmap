...
export const POWER_UPS: Record<PowerUpId, PowerUpDef> = {
  ...
  'cape-feather': {
    ...
    name: 'Cape Feather',
    emoji: '🪶',
    description: 'Fly over opponents — no captures either way',
    tier: 'common',
    timing: 'after-roll',
  },
  'coin-block': {
  ...
  'banana-peel': {
    ...
    name: 'Banana Peel',
    emoji: '🍌',
    description: 'Place on any square — whoever lands on it slips back 3',
    tier: 'uncommon',
    timing: 'after-roll',
  },
  'blue-shell': {
  ...
  'bullet-bill': {
    ...
    name: 'Bullet Bill',
    emoji: '🚀',
    description: 'Rocket forward 10 spaces — immune during move',
    tier: 'rare',
    timing: 'before-roll',
  },
  'lightning-bolt': {
    ...
    name: 'Lightning Bolt',
    emoji: '⚡',
    description: 'All opponents move half dice next turn',
    tier: 'rare',
    timing: 'before-roll',
  },
  'star': {
  ...
  'golden-mushroom': {
    ...
    emoji: '✨',
    description: 'Roll 3 times — pick the best result',
    tier: 'rare',
    timing: 'before-roll',
  },
};
